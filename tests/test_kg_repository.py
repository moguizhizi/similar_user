...
class KgRepositoryTest(unittest.TestCase):
    ...
    def test_training_order_queries_require_taskset_total_scores(self) -> None:
        for query in (
            PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_DATED_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_LOCAL_SAMPLING_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_AGE_ONLY_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            ...
            with self.subTest(query=query[:80]):
                self.assertIn("s1.`总分` IS NOT NULL", query)
                self.assertIn("s2.`总分` IS NOT NULL", query)
    ...
    def test_training_order_dual_window_queries_constrain_both_tasksets(self) -> None:
        for query in (
            PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_LOCAL_SAMPLING_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            PATIENT_TASKSET_DISEASE_TASKSET_PATIENT_TRAINING_ORDER_AGE_ONLY_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            ...
            with self.subTest(query=query[:80]):
                self.assertIn("date(s1.`训练日期`) >= date($start_date)", query)
                self.assertIn("date(s1.`训练日期`) < date($end_date)", query)
                self.assertIn("date(s2.`训练日期`) >= date($start_date)", query)
                self.assertIn("date(s2.`训练日期`) < date($end_date)", query)
                self.assertIn("date(s1.`训练日期`) >= date(s2.`训练日期`)", query)
                self.assertIn("s1.`总分` IS NOT NULL", query)
                self.assertIn("s2.`总分` IS NOT NULL", query)
    ...
    def test_load_query_settings_from_yaml(self) -> None:
        ...
        self.assertFalse(
            settings.training_task_prediction.similar_user_game_counts_weighted_sort_enabled
        )
        self.assertFalse(
    ...
    def test_get_pattern_statistics_prefers_lightweight_dual_window_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [
            {
                ...
                "gCount": 1,
                "p2Count": None,
                "statisticsMode": "source_group_count",
            }
        ]
        repository = KgRepository(client=mock_client)
        ...
        result = repository.get_pattern_statistics(
            pattern=PathPattern.PATIENT_TASKSET_TASK_GAME_TASK_TASKSET_PATIENT,
            query_family=PatternQueryFamily.TRAINING_ORDER_DUAL_WINDOW,
            patient_id=" 30010096 ",
            start_date=" 2022-01-01 ",
            end_date=" 2022-01-13 ",
        )
        ...
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_SOURCE_GROUP_COUNT_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2022-01-01",
                "end_date": "2022-01-13",
    ...
    def test_get_pattern_randomized_paths_selects_training_order_local_sampling_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"p": {"id": "30010096"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_TASK_GAME_TASK_TASKSET_PATIENT,
            query_family=PatternQueryFamily.TRAINING_ORDER_LOCAL_SAMPLING_SOURCE_WINDOW,
            patient_id=" 30010096 ",
        ...
        self.assertEqual(result, [{"row": {"p": {"id": "30010096"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_LOCAL_SAMPLING_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_selects_training_order_age_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"p": {"id": "30010096"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_TASK_GAME_TASK_TASKSET_PATIENT,
            query_family=PatternQueryFamily.TRAINING_ORDER_AGE_SOURCE_WINDOW,
            patient_id=" 30010096 ",
            start_date=" 2026-05-11 ",
            end_date=" 2026-05-25 ",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"p": {"id": "30010096"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_AGE_ONLY_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_selects_training_order_age_edu_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"p": {"id": "30010096"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_TASK_GAME_TASK_TASKSET_PATIENT,
            query_family=PatternQueryFamily.TRAINING_ORDER_AGE_EDU_SOURCE_WINDOW,
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"p": {"id": "30010096"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_AGE_EDUCATION_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_selects_training_order_dual_window_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"p": {"id": "30010096"}}}]
        ...
        self.assertEqual(result, [{"row": {"p": {"id": "30010096"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_selects_training_order_age_edu_dual_window_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"p": {"id": "30010096"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_TASK_GAME_TASK_TASKSET_PATIENT,
            query_family=PatternQueryFamily.TRAINING_ORDER_AGE_EDU_DUAL_WINDOW,
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"p": {"id": "30010096"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASK_SET_TASK_GAME_TASK_SET_PATIENT_TRAINING_ORDER_AGE_EDUCATION_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_maps_entity_layer1_to_age_only_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"dis": {"id": "D1"}}}]
        repository = KgRepository(client=mock_client)

        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_DISEASE_TASKSET_PATIENT,
            query_family="training_order_age_completed_source_window",
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"dis": {"id": "D1"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASKSET_DISEASE_TASKSET_PATIENT_TRAINING_ORDER_AGE_ONLY_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_maps_entity_dual_layer1_to_age_only_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"dis": {"id": "D1"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_DISEASE_TASKSET_PATIENT,
            query_family="training_order_age_completed_dual_window",
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"dis": {"id": "D1"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASKSET_DISEASE_TASKSET_PATIENT_TRAINING_ORDER_AGE_ONLY_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_maps_unknown_layer3_to_age_education_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"un": {"id": "U1"}}}]
        repository = KgRepository(client=mock_client)

        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_UNKNOWN_TASKSET_PATIENT,
            query_family="training_order_age_edu_task_completed_source_window",
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"un": {"id": "U1"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASKSET_UNKNOWN_TASKSET_PATIENT_TRAINING_ORDER_AGE_EDUCATION_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
    ...
    def test_get_pattern_randomized_paths_maps_unknown_dual_layer3_to_age_education_query(
        self,
    ) -> None:
        mock_client = Mock()
        mock_client.run_query.return_value = [{"row": {"un": {"id": "U1"}}}]
        ...
        result = repository.get_pattern_randomized_paths(
            pattern=PathPattern.PATIENT_TASKSET_UNKNOWN_TASKSET_PATIENT,
            query_family="training_order_age_edu_task_completed_dual_window",
            patient_id="30010096",
            start_date="2026-05-11",
            end_date="2026-05-25",
            per_group=3,
        ...
        self.assertEqual(result, [{"row": {"un": {"id": "U1"}}}])
        mock_client.run_query.assert_called_once_with(
            query=PATIENT_TASKSET_UNKNOWN_TASKSET_PATIENT_TRAINING_ORDER_AGE_EDUCATION_DUAL_WINDOW_RANDOMIZED_PATH_BY_DATE_RANGE_QUERY,
            parameters={
                "patient_id": "30010096",
                "start_date": "2026-05-11",
                "end_date": "2026-05-25",
