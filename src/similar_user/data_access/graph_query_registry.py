...
PATIENT_TRAINING_HISTORY_SPECS = (
    ...
    _spec(
        name="patient_total_score_timepoints",
        category=GraphQueryCategory.PATIENT_TRAINING_HISTORY,
        description="查询患者带总分的训练时间点",
        source_label="Patient",
        source_parameters=("patient_id",),
        path_shape="(p:Patient)--(s:TaskInstanceSet)",
        row_fields=("instance_set_id", "training_date", "total_score"),
        query=PATIENT_TOTAL_SCORE_TIMEPOINTS_QUERY,
    ),
    _spec(
        name="patient_total_score_by_date",
        category=GraphQueryCategory.PATIENT_TRAINING_HISTORY,
        description="查询患者指定训练日期的总分",
        source_label="Patient",
        source_parameters=("patient_id", "training_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)",
        row_fields=("instance_set_id", "training_date", "total_score"),
...
PATIENT_ENTITY_COLLECTION_SPECS = (
    ...
    _spec(
        ...
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者从某日期开始的去重 TaskInstance 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(i1:TaskInstance)",
        row_fields=("i1",),
        query=PATIENT_DISTINCT_TASK_INSTANCES_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_distinct_task_instances_by_end_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者早于 end_date 的去重 TaskInstance 节点",
        source_label="Patient",
        source_parameters=("patient_id", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(i1:TaskInstance)",
        row_fields=("i1",),
    ...
    _spec(
        name="patient_distinct_task_instances_by_date_range",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者左闭右开日期区间内的去重 TaskInstance 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(i1:TaskInstance)",
        row_fields=("i1",),
    ...
    _spec(
        name="patient_distinct_symptoms_by_start_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者从某日期开始的去重 Symptom 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(sym:Symptom)",
        row_fields=("sym",),
        query=PATIENT_DISTINCT_SYMPTOMS_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_distinct_symptoms_by_end_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者早于 end_date 的去重 Symptom 节点",
        source_label="Patient",
        source_parameters=("patient_id", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(sym:Symptom)",
        row_fields=("sym",),
    ...
    _spec(
        name="patient_distinct_symptoms_by_date_range",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者左闭右开日期区间内的去重 Symptom 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(sym:Symptom)",
        row_fields=("sym",),
    ...
    _spec(
        name="patient_distinct_diseases_by_start_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者从某日期开始的去重 Disease 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(dis:Disease)",
        row_fields=("dis",),
        query=PATIENT_DISTINCT_DISEASES_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_distinct_diseases_by_end_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者早于 end_date 的去重 Disease 节点",
        source_label="Patient",
        source_parameters=("patient_id", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(dis:Disease)",
        row_fields=("dis",),
    ...
    _spec(
        name="patient_distinct_diseases_by_date_range",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者左闭右开日期区间内的去重 Disease 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(dis:Disease)",
        row_fields=("dis",),
    ...
    _spec(
        name="patient_distinct_unknowns_by_start_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者从某日期开始的去重 Unknown 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(un:Unknown)",
        row_fields=("un",),
        query=PATIENT_DISTINCT_UNKNOWNS_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_distinct_unknowns_by_end_date",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者早于 end_date 的去重 Unknown 节点",
        source_label="Patient",
        source_parameters=("patient_id", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(un:Unknown)",
        row_fields=("un",),
    ...
    _spec(
        name="patient_distinct_unknowns_by_date_range",
        category=GraphQueryCategory.PATIENT_ENTITY_COLLECTION,
        description="查询患者左闭右开日期区间内的去重 Unknown 节点",
        source_label="Patient",
        source_parameters=("patient_id", "start_date", "end_date"),
        path_shape="(p:Patient)--(s1:TaskInstanceSet)--(un:Unknown)",
        row_fields=("un",),
...
PATIENT_SET_COMPARISON_SPECS = (
    _spec(
        name="patient_game_set_comparison_by_start_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者从某日期开始的 Game 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "start_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(:TaskInstance)--(g:Game)",
        row_fields=("games1", "games2"),
        query=PATIENT_GAME_SET_COMPARISON_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_game_set_comparison_by_end_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者早于 end_date 的 Game 集合",
        source_label="Patient",
    ...
    _spec(
        name="patient_game_set_comparison_by_date_range",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者左闭右开日期区间内的 Game 集合",
        source_label="Patient",
        source_parameters=(
            "primary_patient_id",
    ...
    _spec(
        name="patient_symptom_set_comparison_by_start_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者从某日期开始的 Symptom 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "start_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(sym:Symptom)",
        row_fields=("symptoms1", "symptoms2"),
        query=PATIENT_SYMPTOM_SET_COMPARISON_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_symptom_set_comparison_by_end_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者早于 end_date 的 Symptom 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "end_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(sym:Symptom)",
        row_fields=("symptoms1", "symptoms2"),
    ...
    _spec(
        name="patient_symptom_set_comparison_by_date_range",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者左闭右开日期区间内的 Symptom 集合",
        source_label="Patient",
        source_parameters=(
            "primary_patient_id",
            "comparison_patient_id",
    ...
    _spec(
        name="patient_disease_set_comparison_by_start_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者从某日期开始的 Disease 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "start_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(dis:Disease)",
        row_fields=("diseases1", "diseases2"),
        query=PATIENT_DISEASE_SET_COMPARISON_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_disease_set_comparison_by_end_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者早于 end_date 的 Disease 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "end_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(dis:Disease)",
        row_fields=("diseases1", "diseases2"),
    ...
    _spec(
        name="patient_disease_set_comparison_by_date_range",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者左闭右开日期区间内的 Disease 集合",
        source_label="Patient",
        source_parameters=(
            "primary_patient_id",
            "comparison_patient_id",
    ...
    _spec(
        name="patient_unknown_set_comparison_by_start_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者从某日期开始的 Unknown 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "start_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(un:Unknown)",
        row_fields=("unknowns1", "unknowns2"),
        query=PATIENT_UNKNOWN_SET_COMPARISON_BY_START_DATE_QUERY,
    ),
    _spec(
        name="patient_unknown_set_comparison_by_end_date",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者早于 end_date 的 Unknown 集合",
        source_label="Patient",
        source_parameters=("primary_patient_id", "comparison_patient_id", "end_date"),
        path_shape="(p:Patient)--(s:TaskInstanceSet)--(un:Unknown)",
        row_fields=("unknowns1", "unknowns2"),
    ...
    _spec(
        name="patient_unknown_set_comparison_by_date_range",
        category=GraphQueryCategory.PATIENT_SET_COMPARISON,
        description="比较两个患者左闭右开日期区间内的 Unknown 集合",
        source_label="Patient",
        source_parameters=(
            "primary_patient_id",
            "comparison_patient_id",
...
PATIENT_SCORE_COMPARISON_SPECS = (
    ...
    _spec(
        name="patient_total_scores_by_disease_course_window",
        category=GraphQueryCategory.PATIENT_SCORE_COMPARISON,
        description="查询患者左闭右开病程窗口内有总分的 TaskInstanceSet",
        source_label="Patient",
        source_parameters=(
            "patient_id",
            "base_date",
